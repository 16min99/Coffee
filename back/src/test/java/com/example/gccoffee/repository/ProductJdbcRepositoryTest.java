...
class ProductJdbcRepositoryTest {
    ...
    void testFindById() {
        var findProduct = repository.findById(newProduct.getProductId());
    ...
    void testFindByName() {
        var findProduct = repository.findByName(newProduct.getProductName());

        assertThat(findProduct.get().getProductName(), is("new-product"));
        assertThat(findProduct.get(), samePropertyValuesAs(newProduct));
    }
